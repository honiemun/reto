...
> Reto was primarily developed from 2021 to 2024. No further major updates are planned, but its code is source-available if you wish to tinker with it. The code is provided "as-is", and the Reto development team can not guarantee prolonged support.
